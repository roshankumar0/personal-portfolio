'use client'
import { login } from '@/servicesApi/userServices'
    ...
    return (
      ...
      flex items-center justify-center">
                ...
                <div className="w-full h-100">
                    ...
                    <form className="mt-6" action="" onSubmit={handlLogin}>
                        <div>
                            <label className="block text-gray-700">Email Address</label>
                            <input value={data.email} onChange={handlSubmit} name="email" type="email" id="email" placeholder="Enter Email Address" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autoFocus autoComplete='' required />
                        </div>

                        <div className="mt-4">
                            <label className="block text-gray-700">Password</label>
                            <input value={data.password} onChange={handlSubmit} name="password" type="password" id="password" placeholder="Enter Password" minLength="6" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
            ...
            px-4 py-3 mt-6">Log In</button>
                    ...
                    <Link href="/signup">
                        <h3 className="mt-8 text-blue-500 hover:text-blue-700 font-semibold">
